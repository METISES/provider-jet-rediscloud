...
PROJECT_NAME := provider-jet-rediscloud
PROJECT_REPO := github.com/timgchile/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.1.6

export TERRAFORM_PROVIDER_SOURCE := RedisLabs/rediscloud
export TERRAFORM_PROVIDER_VERSION := 0.2.8
export TERRAFORM_PROVIDER_DOWNLOAD_NAME :=  terraform-provider-rediscloud
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/RedisLabs/terraform-provider-rediscloud/releases/download/v0.2.8
...
IMAGES = provider-jet-rediscloud provider-jet-rediscloud-controller
